...
<head>
  ...
  <link rel="stylesheet" href="assets/css/button_kew.css" />
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <select id="yearSelector" class="form-control">
                    <?php foreach ($years as $year) {
                      $buddhistYear = $year; // แปลงปี ค.ศ. เป็น ปี พ.ศ.
                    ?>
                ...
                <div class="card-body">
                  ...
                  <button id="printPDF" class="btn btn-danger btn-with-bg">
    <span>ปริ้นเป็น PDF</span>
</button>
        ...
        <style>
          @font-face {
            ...
            /* เพิ่ม Base64 ของฟอนต์ที่แปลงแล้วที่นี่ */
          }
      ...
      $(document).ready(function() {
        ...
        function loadTableData(year) {
          $.ajax({
            ...
            success: function(response) {
              $('#petTableContainer').html(response);
              initializeDataTables(); // Reinitialize DataTables
            }
          });
        }
        ...
        function exportToExcel() {
          ...
          var dataTable = $('#petTable').DataTable();
          dataTable.page.len(-1).draw(); // Show all rows

          // Create worksheet
          var worksheet = XLSX.utils.table_to_sheet(table);
          XLSX.utils.book_append_sheet(wb, worksheet, 'Pet Data');

          // Restore default page length
          dataTable.page.len(10).draw();

          // Save Excel file
          XLSX.writeFile(wb, `ข้อมูลสถิติจำนวนสัตว์ในระบบประจำปี_${selectedYear}.xlsx`);
        }
        ...
        $('#printPDF').click(function() {
          ...
          const petTable = $('#petTable').DataTable();
          petTable.page.len(-1).draw(); // Display all rows in the DataTable
          ...
          doc.setFontSize(20);
          doc.text(15, 15, "ข้อมูลสถิติจำนวนสัตว์ในระบบประจำปี ปี: " + selectedYear);
          ...
          // Add chart to a new page in the PDF
          ...
          // Save PDF file
          doc.save(`ข้อมูลสถิติจำนวนสัตว์ในระบบประจำปี_${selectedYear}.pdf`);

          // Restore original pagination
          petTable.page.len(10).draw();
        });
        ...
        // Load initial data
        const initialYear = $('#yearSelector').val();
