...
<div class="modal fade text-center" id="delete_pet<?php echo $row['ID_P'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border-radius: 10px;">
      ...
      <div class="modal-body" id="txtModal">
          ...
          <input type="hidden" name="ID_P" value="<?php echo $row['ID_P'];?>">
          <button type="submit" class="btn btn-success" name="btnDeletePet" id="btnDeletePet"> Yes</button>
