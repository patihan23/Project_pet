...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2024 at 03:40 PM
...
(2, 'นายสมชาย ใจดี', '092384756', '123', '5', 'ในเมือง', '10', '5', '2024-07-26'),
...
--
ALTER TABLE `pet`
  MODIFY `ID_P` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสัตว์เลี้ยง', AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `pet_own`
--
ALTER TABLE `pet_own`
  MODIFY `ID_PO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเจ้าของ', AUTO_INCREMENT=38;
