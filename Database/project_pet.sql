...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2024 at 08:13 PM
...
INSERT INTO `history_v` (`ID_HV`, `HV_date`, `ID_VC`, `ID_OFF`, `ID_P`) VALUES
(1, '2024-07-18', 1, 1, 3),
(2, '2024-07-19', 2, 1, 2),
(3, '2024-07-05', 1, 2, 6),
(4, '2024-07-16', 1, 2, 7),
...
(1, 'kew', '1234', 'ปฏิหาริย์ สุวรรณี', '0823392743', 'lnwqqq@outlook.com', 'แอดมิน', 'admin', '../profile/6699573dc73365.06315334.jpg'),
(2, 'ying', '1234', 'นรินทร์ทิพย์ พระทอง', '0864186548', 'ying@daw', 'admin', 'admin', '../profile/6699574aaefc66.41748137.jpg'),
(3, 'gift', '1234', 'ชฏาพร ก่ำพิมาย', '0816548648', 'gift@fgawed', 'แอดมิน', 'admin', '../profile/6699576fe07e99.56766395.jpg');
...
INSERT INTO `pet` (`ID_P`, `Type_pet`, `Breed`, `Pet_name`, `Gender`, `color`, `weight`, `p_old`, `ID_PO`) VALUES
(2, 1, 'บีเกิล', 'บีเกิล', 1, 'ดำ', '5000', '0000-00-00', 1),
(3, 2, 'แมว', 'แมวสีดำ', 2, 'ดำ', '3000', '0000-00-00', 2),
(4, 1, 'ลาบราดอร์', 'ราดอร์', 1, 'น้ำตาล', '4500', '0000-00-00', 3),
(5, 2, 'สก็อตติช', 'มิวส์', 2, 'เทา', '4000', '0000-00-00', 4),
(6, 1, 'ชิวาวา', 'ชิวาวา', 1, 'ขาว', '6000', '0000-00-00', 5),
(7, 2, 'เปอร์เซีย', 'แจ็กสัน', 1, 'ดำ', '3500', '0000-00-00', 6),
(8, 1, 'บีเกิล', 'บีเกิล', 2, 'ดำ', '4800', '0000-00-00', 7),
(9, 2, 'แมวไทย', 'ตากล้อง', 1, 'ขาว', '3800', '0000-00-00', 8),
(10, 1, 'พุดเดิล', 'ปุ้มปุ้ย', 1, 'น้ำตาล', '5200', '0000-00-00', 9),
(11, 2, 'สก็อตติช', 'สก็อตติช', 2, 'เทา', '4200', '0000-00-00', 10),
(12, 1, 'ชิวาวา', 'ชิวาวา', 1, 'ขาว', '5800', '0000-00-00', 11),
(13, 2, 'เปอร์เซีย', 'แมวแจ็กสัน', 1, 'ดำ', '3700', '0000-00-00', 12),
(14, 1, 'บีเกิล', 'บีเกิล', 1, 'ดำ', '4900', '0000-00-00', 13),
(15, 2, 'แมวไทย', 'ทอร์ที', 2, 'ขาว', '3900', '0000-00-00', 14),
(16, 1, 'ลาบราดอร์', 'โรส', 1, 'น้ำตาล', '5300', '0000-00-00', 15),
(17, 2, 'สก็อตติช', 'มิสเตอร์', 1, 'เทา', '4300', '0000-00-00', 16),
(18, 1, 'ชิวาวา', 'เฟี๊ยะ', 2, 'ขาว', '5900', '0000-00-00', 17),
(19, 2, 'เปอร์เซีย', 'แจ็กสัน', 1, 'ดำ', '3600', '0000-00-00', 18),
(20, 1, 'บีเกิล', 'บีเกิล', 1, 'ดำ', '5000', '0000-00-00', 19),
(21, 2, 'แมวไทย', 'เรน', 2, 'ขาว', '4000', '0000-00-00', 20),
(22, 1, 'ลาบราดอร์', 'ลาบราดอร์', 1, 'น้ำตาล', '5400', '0000-00-00', 21),
(23, 2, 'สก็อตติช', 'ซาฟาเลีย', 1, 'เทา', '4400', '0000-00-00', 22),
(24, 1, 'ชิวาวา', 'ชิวาวา', 2, 'ขาว', '6000', '0000-00-00', 23),
(25, 2, 'เปอร์เซีย', 'แมวแจ็กสัน', 1, 'ดำ', '3700', '0000-00-00', 24),
(26, 1, 'บีเกิล', 'บีเกิล', 1, 'ดำ', '4800', '0000-00-00', 25);
...
(29, 'นายสมชาย หล่อหลอ', '1902837495', '890', '6', 'ในเมือง');
...
(1, 'วัคซีนพิษสุนัขบ้า', 'แช่เย็น', '2026-07-08', 100),
(2, 'วัคซีนโรคหัด', 'แช่เย็น', '2025-08-15', 50),
...
(15, 'วัคซีนโรคหัด', 'แช่เย็น', '2025-09-05', 50);
...
--
ALTER TABLE `history_v`
  MODIFY `ID_HV` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการฉีดวัคซีน', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `official`
--
ALTER TABLE `official`
  MODIFY `ID_OFF` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเจ้าหน้าที่', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `pet`
--
ALTER TABLE `pet`
  MODIFY `ID_P` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสัตว์เลี้ยง', AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `pet_own`
--
ALTER TABLE `pet_own`
  MODIFY `ID_PO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสเจ้าของ', AUTO_INCREMENT=30;
...
--
ALTER TABLE `vaccine`
  MODIFY `ID_VC` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสวัคซีน', AUTO_INCREMENT=16;
